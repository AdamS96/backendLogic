 ...
 */
    ...
    void setUp() {
        ...
        applicant = new Applicant(3L, "prefix", "firstName", "lastName", "telephone", "address1", "address2",
                ...
                "10000", "N/A", 0.0 );
        applicant2 = new Applicant(4L, "prefix", "firstName", "lastName", "telephone", "address1", "address2",
                "city", "postcode","Cabriolet", "3000", "1", "No", "No", "date",
                "15000", "N/A", 0.0 );
        applicant3 = new Applicant(5L, "prefix", "firstName", "lastName", "telephone", "address1", "address2",
